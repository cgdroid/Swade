...
import com.tmhnry.swade.databinding.FragmentEntityStocksBinding;
...
public class EntityStocksFragment extends Fragment {
    public static final String FRAGMENT_ID = "tmhnry.employeeproductivity.entitystocksfragment";
    FragmentEntityStocksBinding binding;
    TableLayout table;
    WindowManager windowManager;
    DisplayMetrics metrics;
    PieChart pieChart;

    public EntityStocksFragment() {
    }

    public static EntityStocksFragment Builder() {
        EntityStocksFragment fragment = new EntityStocksFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentEntityStocksBinding.inflate(inflater, container, false);
